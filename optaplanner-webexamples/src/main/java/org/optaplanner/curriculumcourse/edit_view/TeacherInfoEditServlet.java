 ...
 * @author gurhan
 */
@WebServlet("/curriculumcourse/TeacherInfoEditServlet")
public class TeacherInfoEditServlet extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Teacher teacher = tdao.find(Teacher.class, Long.parseLong(id));
        List<TeacherDegree> allDegree = tdDao.findAll();
        System.out.println("Liste uzunlugu" + allDegree.size());
