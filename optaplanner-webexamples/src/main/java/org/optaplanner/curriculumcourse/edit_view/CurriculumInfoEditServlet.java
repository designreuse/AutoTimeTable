 ...
 * @author gurhan
 */
@WebServlet("/curriculumcourse/CurriculumInfoEditServlet")
public class CurriculumInfoEditServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        Curriculum curriculum = cDao.find(Curriculum.class, Long.parseLong(id));
