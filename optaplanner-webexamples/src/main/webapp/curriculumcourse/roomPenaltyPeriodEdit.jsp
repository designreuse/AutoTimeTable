...
<html>
    <head>
        ...
        <title>Derslik Günleri Düzenleme Sayfası</title>
    </head>
    ...
    <body>
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <header class="main-page-header" style="margin-bottom: 20px">
                    ...
                    <center style="margin-top: 15px"> 
                        ...
                        <h2>Derslik Günleri Düzenleme Sayfası</h2>
                        <h3>${teacher.degree.shortName} ${teacher.name} ${teacher.surname}</h3>
                        <h4>Dersliğin kullanılamayacağı günleri işaretleyiniz</h4>
            ...
            <form method="POST" action="SaveRoomPeriodPenalty">
                ...
                <div class="row">
                    ...
                    <a href="RoomsViewServlet" type="submit" class="btn btn-danger col-md-1" >Geri Dön</a>
                </div>
            </form>
        </div>
    </body>
